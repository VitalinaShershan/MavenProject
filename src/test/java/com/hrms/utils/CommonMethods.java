...
public class CommonMethods extends PageInitializer {
    ...
    /**
     * this method will click on a radio button or check box by the given list of elements and value
    ...
    /**
     * this method will click on a radio button or check box by the given list of elements and text value
     * @param radioOrCheckBoxes
     * @param value
     */
    ...
    /**
     * this method will select a value fromo a given dropDown by the given visible text
     * @param dd
     * @param visibleText
     */
...
public static void selectDDValue(WebElement dd, int index){
    ...
    /**
     * this method will switch to a farme by the given frame index
     * @param frameIndex
     */
    ...
    /**
     * this method will switch to a farme by the given name or id
     * @param nameOrId
     */
    ...
    public static void switchToChildWindow(){
       String mainWindow =driver.getWindowHandle(); //40 alfabetic characters id = 1 window
